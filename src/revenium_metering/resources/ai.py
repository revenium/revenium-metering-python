...
class AIResource(SyncAPIResource):
    ...
    def create_completion(
        ...
        *,
        ...
        This endpoint
        tracks token usage, costs, and performance metrics for AI model completions.
        **Base URL:** Use the metering endpoint `/meter/v2/ai/completions` (not
        `/profitstream/v2/ai/completions`)
        ...
        Args:
          ...
          response_quality_score: Optional quality score for the AI response, typically on a 0-100 scale. Set by
              your application's evaluation logic (e.g., RAGAS, human feedback, custom
          ...
          transaction_id: Unique identifier for this specific AI completion transaction. Used for
              ...
              the same ID when submitting to Revenium.
