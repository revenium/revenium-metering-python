...
When the library is unable to connect to the API (for example, due to network connection problems or a timeout), a subclass of `revenium_metering.APIConnectionError` is raised.
